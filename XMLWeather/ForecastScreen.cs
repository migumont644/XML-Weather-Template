...
namespace XMLWeather
{
    public partial class ForecastScreen : UserControl
    {
        ...
        {          
            ...
            else if (Convert.ToInt32(Form1.days[1].conditionCode) >= 232 && Convert.ToInt32(Form1.days[0].conditionCode) <= 232)
            {
                pictureBox1.Image = XMLWeather.Properties.Resources.thunder_icon;
            }
            else if (Convert.ToInt32(Form1.days[1].conditionCode) >= 600 && Convert.ToInt32(Form1.days[0].conditionCode) <= 622)
            {
                pictureBox1.Image = XMLWeather.Properties.Resources.snow_icon;
            }
            else if (Convert.ToInt32(Form1.days[1].conditionCode) >= 500 && Convert.ToInt32(Form1.days[0].conditionCode) <= 531)
            {
            ...
            else if (Convert.ToInt32(Form1.days[2].conditionCode) >= 232 && Convert.ToInt32(Form1.days[0].conditionCode) <= 232)
            {
                pictureBox2.Image = XMLWeather.Properties.Resources.thunder_icon;
            }
            else if (Convert.ToInt32(Form1.days[2].conditionCode) >= 600 && Convert.ToInt32(Form1.days[0].conditionCode) <= 622)
            {
                pictureBox2.Image = XMLWeather.Properties.Resources.snow_icon;
            }
            else if (Convert.ToInt32(Form1.days[2].conditionCode) >= 500 && Convert.ToInt32(Form1.days[0].conditionCode) <= 531)
            {
            ...
            if (Convert.ToInt32(Form1.days[4].conditionCode) == 800)
            {
                pictureBox4.Image = XMLWeather.Properties.Resources.sunny_icon;
            }
            else if (Convert.ToInt32(Form1.days[4].conditionCode) >= 232 && Convert.ToInt32(Form1.days[0].conditionCode) <= 232)
            {
                pictureBox4.Image = XMLWeather.Properties.Resources.thunder_icon;
            }
            else if (Convert.ToInt32(Form1.days[4].conditionCode) >= 600 && Convert.ToInt32(Form1.days[0].conditionCode) <= 622)
            {
                pictureBox4.Image = XMLWeather.Properties.Resources.snow_icon;
            }
            else if (Convert.ToInt32(Form1.days[4].conditionCode) >= 500 && Convert.ToInt32(Form1.days[0].conditionCode) <= 531)
            {
                pictureBox4.Image = XMLWeather.Properties.Resources.rain_icon;
            }
            else if (Convert.ToInt32(Form1.days[4].conditionCode) <= 801)
            {
